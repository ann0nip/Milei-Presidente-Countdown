...
function shootFirework(dirX, dirY) {
    ...
    fireworksArr.push({
        rocket: rocket,
        maxHeight: canvas.height - maxHeight / 2,
        deleteTimeout: false,
    });
}
...
function animate() {
    ...
    for (let firework = 0; firework < fireworksArr.length; firework++) {
        ...
        if (
            fireworksArr[firework].rocket.posY <=
            fireworksArr[firework].maxHeight
        ) {
            explodeFirework(
                fireworksArr[firework].rocket.posX,
                fireworksArr[firework].rocket.posY,
                fireworksArr[firework].rocket.color
            );
